...
import com.example.dell.dishservices.ViewHolder.CardAdapter;
import com.example.dell.dishservices.common.Common;
import com.example.dell.dishservices.model.Order;
import com.example.dell.dishservices.model.Request;
...
public class Cart extends AppCompatActivity {
    ...
    private void showAlertDialog() {
        ...
        alertDialog.setTitle("Dish Sevices");
       ...
       alertDialog.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
           ...
           public void onClick(DialogInterface dialog, int which) {
               ...
               Toast.makeText(Cart.this,"Tnks bhai,Order,Place",Toast.LENGTH_LONG).show();
               finish();
